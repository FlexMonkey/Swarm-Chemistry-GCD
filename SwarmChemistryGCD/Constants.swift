...
struct Constants
{
    static let genomeOne = SwarmGenome(color: UIColor.blueColor(), radius: 25, c1_cohesion: 0.25, c2_alignment: 0.25, c3_seperation: 75, c4_steering: 0.5, c5_paceKeeping: 1);
    ...
    static let genomeThree = SwarmGenome(color: UIColor.whiteColor(), radius: 15, c1_cohesion: 0.75, c2_alignment: 4, c3_seperation: 25, c4_steering: 1, c5_paceKeeping: 0.25);
