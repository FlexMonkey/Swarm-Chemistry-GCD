...
struct Constants
{
    ...
    static let genomeThree = SwarmGenome(color: UIColor.blueColor(), radius: 15, c1_cohesion: 1.05, c2_alignment: 0.8, c3_seperation: 25, c4_steering: 0.333, c5_paceKeeping: 0.25);
